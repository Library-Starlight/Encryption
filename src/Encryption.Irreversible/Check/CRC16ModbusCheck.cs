...
namespace Encryption.Irreversible.Check
{
    ...
    public class CRC16ModbusCheck
    {
        ...
        /// <returns></returns>
        public static bool Check(byte[] data, byte[] checkSum)
        {
            var realSum = GetModbusCrc16(data);
            return realSum[0] == checkSum[0] && realSum[1] == checkSum[1];
        }
